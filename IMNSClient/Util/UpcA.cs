...
namespace IMNSClient.Util
{
    public class UpcA
    {
        ...
        //private float _fWidth = (float)(1.469 * 0.8);
        //private float _fHeight = (float)(1.02 * 0.8);
        ...
        /// <summary>
        /// added by Loc huynh to implement our barcode
        /// </summary>
        /// <param name="barcodeA"></param>
        public UpcA(string barcodeA, bool bIsNormal)
        {
            string productType;
            string mfgNumber;
            string productId;
            ...
            //ex: 619828100313
            productType = barcodeA.Substring(0, 1);
            mfgNumber = barcodeA.Substring(1, 5);
            productId = barcodeA.Substring(6, 5);
            checkDigit = barcodeA.Substring(11, 1);
            ...
            if (bIsNormal == false) //minimum size
            {
                //resize 
                _fWidth = (float)(1.469 * 0.8);
                _fHeight = (float)(1.02 * 0.5);
            }
        }
        ...
        /// <summary>
        /// Loc Huynh: modified to get the latest position, so we can draw multiple barcode in one line.
        /// </summary>
        /// <param name="g"></param>
        /// <param name="pt"></param>
        /// <returns></returns>
        public PointF DrawUpcaBarcode(System.Drawing.Graphics g, System.Drawing.PointF pt)
        {
            ...
            //lht added here to modify xPosition should be assigned to the position of X and Y.
            xPosition = pt.X;
        ...
        /// 0 - Regular UPC codes 
        /// 1 - Reserved 
        /// 2 - Weight ites marked at the store 
        ...
        public string ProductType
        {
            ...
            set
            {
                ...
                //06/22/16 - lht removed to support nail supply
